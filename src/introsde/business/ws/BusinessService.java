 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://ws.business.introsde/", wsdlLocation = "https://business--service.herokuapp.com/business?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://business--service.herokuapp.com/business?wsdl");
